...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 18, 2020 at 06:55 AM
...
INSERT INTO `alumni_list` (`id`, `batch`, `name`, `father_name`, `mother_name`, `spouse_name`, `present_village`, `present_post_office`, `present_upagila`, `present_district`, `permanent_village`, `permanent_post_office`, `permanent_upagila`, `permanent_district`, `profession`, `email_id`, `mobile_number`, `present_access`, `mobile_access`, `image`, `approval_status`, `insertion_date`) VALUES
(21, '1965', 'MD GOLAM MOKTADIR', 'MD NURUL ISLAM MONDAL', 'Most Laila Arzumand Banu', 'abc', 'kalabagan', 'kalabagan', 'Dhaka', 'Dhaka', 'kalabagan', 'kalabagan', 'Dhaka', 'Dhaka', 'BUSINESS', 'cse.limon.33@gmail.com', '+8801773080682', 1, 1, '1.PNG', 11, '2020-07-11 04:14:13pm');
...
INSERT INTO `online_class` (`record_id`, `class_id`, `group_id`, `subject_id`, `section_id`, `topic_name`, `link`) VALUES
(1, 8, 4, 6, 3, 'xdfv', 'sujaul_pdf13.pdf'),
(2, 7, 3, 2, 3, 'xdfv', 'https://www.youtube.com/watch?v=a_qREkJ78f4&list=PL0b6OzIxLPbyrzCMJOFzLnf_-_5E_dkzs'),
(3, 7, 1, 3, 5, 'xdfv', 'https://www.youtube.com/watch?v=V9c2M7c5xqU&list=PL0b6OzIxLPbyrzCMJOFzLnf_-_5E_dkzs&index=4'),
(4, 7, 3, 4, 4, 'xdfv', 'https://www.youtube.com/watch?v=oXX2SJKijig&list=PL0b6OzIxLPbyrzCMJOFzLnf_-_5E_dkzs&index=6'),
(5, 7, 3, 2, 3, 'Bangla tutorial', 'https://www.youtube.com/watch?v=V9c2M7c5xqU&list=PL0b6OzIxLPbyrzCMJOFzLnf_-_5E_dkzs&index=4');
...
INSERT INTO `permissions` (`id`, `menu`, `submenu`, `user_id`) VALUES
(1, 'dashboard@users@software@accounts@website', 'permission@create_option@student_management@teacher_management@staff_management@attendance_system@subject_assignment@marks_distribution@result@certificates@sms_system@library@backup@fees_collection@bank_history@employee_history@accounting@update_news@basic_info@photo_gallery@managing_profile@class_routine@exam_routine@academic_calendar@book_list@syllabus@notice_board@previous_managing_committe@alumni@online_class', 1);
