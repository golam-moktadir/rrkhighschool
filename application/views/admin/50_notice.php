    ...
    <div class="row" style="margin-top: 55px;">
        <section class="col-xs-12 connectedSortable">
            <div class="" style="color: black;">
                <form action="<?php echo base_url('Insert/notice')?>" method="post" enctype="multipart/form-data">
                <div class="box-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-3 col-xs-12">
                            ...
                            <input type="text" readonly class="form-control new_datepicker" required id="date"
                                    placeholder="Select Date" autocomplete="off"
                                    name="date">
                        </div>
                        <div class="form-group col-sm-3 col-xs-12">
                            <label for="particular">Particular</label><small class="req">*</small>
                            <input type="text" class="form-control" id="particular" required placeholder=""
                                    name="particular">
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-sm-6 col-xs-12">
                            <label for="details">Upload PDF</label><small class="req">*</small>
                            <input type="file" name="details" required>
                        </div>
