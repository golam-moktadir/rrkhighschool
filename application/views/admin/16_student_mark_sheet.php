            ...
            <section class="col-xs-12 connectedSortable">
                <div class="" style="color: black;" id="no_print1">
                    <form id="specific_mark_sheet_form">
                        <div class="box-body">
                            <p style="font-size: 20px;">Search Progress Report by ID</p>
                            <div class="row">
                                ...
                                <div class="form-group col-sm-3 col-xs-12">
                                    <label for="published_date2">Date of Publication</label>
                                    <input type="text" class="form-control new_datepicker" id="published_date2"
                                           placeholder="Select Date" name="published_date2"
                                           value="<?php echo date('d-m-Y'); ?>" autocomplete="off">
                                </div>
                                <div class="box-footer col-sm-3 clearfix" style="margin-top: 27px">
                                    <button id="specific_mark_sheet_btn" type="button"
                    ...
                    <form id="mark_sheet_form">
                        <div class="box-body">
                            ...
                            <div class="row">
                                ...
                                <div class="box-footer col-sm-3 clearfix" style="margin-top: 27px">
                                    <button id="mark_sheet_btn" type="button" class="pull-left btn btn-success">Show <i
                                                class="fa fa-arrow-circle-right"></i></button>
                                </div>
                            </div>
                        </div>
...
<script type="text/javascript">
    window.onload = function () {
        $("#mark_sheet_btn").click(function () {
            $.ajax({
                type: "POST",
                url: "<?php echo base_url(); ?>Get_ajax_value/get_all_mark_sheet",
                data: $('#mark_sheet_form').serialize(),
                success: function (data) {
                    $('#show_mark_sheet').html(data);
                }
            });
        });
        $("#specific_mark_sheet_btn").click(function () {
            $.ajax({
                type: "POST",
                url: "<?php echo base_url(); ?>Get_ajax_value/get_specific_mark_sheet",
