        ...
        <div class="row" style="margin-top: 55px;">
            <section class="col-xs-12 connectedSortable">
                <div class="" style="color: black;">
                    <?php echo form_open_multipart('Edit/booklist/' . $record_id); ?>
                    <div class="box-body">
                        <p style="font-size: 20px;">Edit Booklist</p>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-sm-2 col-xs-12">
                                ...
                                <input type="text" class="form-control" id="book_name"
                                       value="<?php echo $book_name; ?>" placeholder="" name="book_name">
                            </div>
                            <div class="form-group col-sm-2 col-xs-12">
                                <label for="author_name">Author Name</label>
                                <input type="text" class="form-control" id="author_name"
                                       value="<?php echo $author_name; ?>" placeholder="" name="author_name">
                            </div>
                            <div class="form-group col-sm-2 col-xs-12">
                                <label for="edition">Edition</label>
                                <input type="text" class="form-control" id="edition"
                                       value="<?php echo $edition; ?>" placeholder="" name="edition">
                            </div>
