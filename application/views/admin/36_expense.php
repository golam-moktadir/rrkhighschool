        ...
        <div class="row" style="margin-top: 55px;">
            <section class="col-xs-12 connectedSortable">
                <div class="" style="color: black;">
                    <?php echo form_open_multipart('Insert/insert_expense'); ?>
                    <div class="box-body">
                        <p style="font-size: 20px;">Expense</p>
                        <p  style="font-size: 20px; color: #066;"><?php echo $msg; ?></p>
                        <div class="container-fluid">
                            <div class="row">
                                <div class="form-group col-sm-2 col-xs-12">
                                    <label for="expense_head_name">Expense Head</label>
                                    <select name="expense_head_name" id="expense_head_name" class="form-control selectpicker"
                                            data-container="body">
