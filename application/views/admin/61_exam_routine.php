        ...
        <div class="row" style="margin-top: 55px;">
            <section class="col-xs-12 connectedSortable">
                <div class="" style="color: black;">
                    <?php echo form_open_multipart('Insert/exam_routine'); ?>
                    <div class="box-body">
                        <p style="font-size: 20px;">Upload Exam Routine</p>
                        ...
                        <table id="example2" class="table table-bordered table-hover">
                            ...
                            foreach ($all_value as $single_value) {
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center;">
                                        <a style="margin: 5px;"
                                           href="<?php echo base_url(); ?>Show_edit_form/exam_routine/<?php echo $single_value->record_id; ?>/main"
                                           class="btn btn-info">Edit
                                        </a>
                                        <a style="margin: 5px;"
                                           href="<?php echo base_url(); ?>Delete/exam_routine/<?php echo $single_value->record_id; ?>/main"
