        ...
        <div class="row" style="margin-top: 55px;">
            <section class="col-xs-12 connectedSortable">
                <div class="" style="color: black;">
                    <?php echo form_open_multipart('Edit/create_designation/' . $record_id); ?>
                    <div class="box-body">
                        <p style="font-size: 20px;">Edit Designation</p>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center;">
                                        <a style="margin: 5px;" class="btn btn-info"
                                           href="<?php echo base_url(); ?>Show_edit_form/create_designation/<?php echo $single_value->record_id; ?>/main">Edit
                                        </a>
