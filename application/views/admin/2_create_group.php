        ...
        <div class="row" style="margin-top: 55px;">
            <section class="col-xs-12 connectedSortable">
                <div class="" style="color: black;">
                    <?php echo form_open_multipart('Insert/create_group'); ?>
                    <div class="box-body">
                        <p style="font-size: 20px;">Create Group</p>
                        <p style="font-size: 20px; color: #066;"><?php echo $msg; ?></p>
                        <div class="row">
                            <div class="col-sm-4 col-xs-8 form-group">
                                <label for="group_name">Group Name</label><small class="req">*</small>
                                <input type="text" class="form-control" id="group_name" required placeholder="Group Name" name="group_name">
                            </div>
