            ...
            <section class="col-xs-12 connectedSortable">
                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-sm-3 col-xs-12">
                                <label for="validity2">Issue Date<b style="color: red;">*</b></label>
                ...
                <div style="color: black;" id="no_print2">
                    <form id="id_card_form">
                        <div class="box-body">
                            <p style="font-size: 20px;">Search for ID Card</p>
                            <div class="row">
                                <div class="form-group col-sm-3 col-xs-12">
                                ...
                                <div class="form-group col-sm-3 col-xs-12" id="section_div">
                                    <label for="section_name">Select Section</b></label>
                                ...
                                <div class="form-group col-sm-3 col-xs-12">
                                    <label for="session_name">Select Year</b></label>
                                ...
                                <div class="form-group col-sm-3 col-xs-12">
                                    <label for="validity">Issue Date<b style="color: red;">*</b></label>
...
<script type="text/javascript">
    window.onload = function () {
        $("#id_card_btn").click(function () {
            $.ajax({
                type: "POST",
                url: "<?php echo base_url(); ?>Get_ajax_value/get_all_id_card",
        ...
        $("#specific_id_card_btn").click(function () {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo base_url(); ?>Get_ajax_value/get_specific_id_card",
                data: post_data,
                success: function (data) {
                    $('#show_id_card').html(data);
                }
