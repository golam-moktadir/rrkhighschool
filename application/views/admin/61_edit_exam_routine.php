        ...
        <div class="row" style="margin-top: 55px;">
            <section class="col-xs-12 connectedSortable">
                <div class="" style="color: black;">
                    <?php echo form_open_multipart('Edit/exam_routine/' . $record_id); ?>
                    <div class="box-body">
                        <p style="font-size: 20px;">Edit Exam Routine</p>
                            ...
                            <tbody style="font-size: 16px;">
                                ...
                                foreach ($all_value as $single_value) {
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: center;">
                                            <a style="margin: 5px;" href="<?php echo base_url(); ?>Show_edit_form/exam_routine/<?php echo $single_value->record_id; ?>/main" 
                                               class="btn btn-info">Edit
                                            </a>
                                            <a style="margin: 5px;" href="<?php echo base_url(); ?>Delete/exam_routine/<?php echo $single_value->record_id; ?>/main" 
