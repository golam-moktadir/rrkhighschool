                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-3 col-xs-12">
                            ...
                            <input type="text" class="form-control" id="designation" required placeholder=""
                                    name="designation">
                        </div>
                        <div class="form-group col-sm-3 col-xs-12">
                            <label for="position">Position</label><small class="req">*</small>
                            <input type="text" class="form-control" id="position" required placeholder=""
                                    name="position">
                        </div>
                        <div class="form-group col-sm-3 col-xs-12">
                        ...
                        <div class="box-footer col-xs-4 clearfix">
                            <button style="margin-top: 27px" class="pull-left btn btn-success">Submit <i
                    ...
                    <table id="example2" class="table table-bordered table-hover">
                        ...
                        foreach ($all_value as $single_value) {
                            ...
                            <tr>
                                ...
                                <td style="text-align: center;"><?php echo $single_value->position; ?></td>
                                <td style="text-align: center;">
