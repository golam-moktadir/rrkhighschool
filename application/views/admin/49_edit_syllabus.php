        ...
        <div class="row" style="margin-top: 55px;">
            <section class="col-xs-12 connectedSortable">
                <div class="" style="color: black;">
                    <?php echo form_open_multipart('Edit/syllabus/' . $record_id); ?>
                    <div class="box-body">
                        <p style="font-size: 20px;">Insert Syllabus</p>
                        ...
                        <div class="row">
                            <div class="form-group col-sm-2 col-xs-12">
                                ...
                                <select name="class_name" id="class_name" class="form-control selectpicker"
                                        data-container="body">
                                    <option value="<?php echo $class_name; ?>">Class - <?php echo $class_name; ?></option>
                            ...
                            <tbody style="font-size: 16px;">
                                ...
                                foreach ($all_value as $single_value) {
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: center;">
                                            <a style="margin: 5px;" href="<?php echo base_url(); ?>Show_edit_form/syllabus/<?php echo $single_value->record_id; ?>/main" 
                                               class="btn btn-info">Edit
                                            </a>
                                            <a style="margin: 5px;" href="<?php echo base_url(); ?>Delete/syllabus/<?php echo $single_value->record_id; ?>/main" 
