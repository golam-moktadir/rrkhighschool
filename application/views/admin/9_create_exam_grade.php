        ...
        <div class="row" style="margin-top: 55px;">
            <section class="col-xs-12 connectedSortable">
                <div class="" style="color: black;">
                    <?php echo form_open_multipart('Insert/create_exam_grade'); ?>
                    <div class="box-body">
                        <p style="font-size: 20px;">Create Exam Grade</p>
                        <p style="font-size: 20px; color: #066;"><?php echo $msg; ?></p>
                        <div class="row">
                            <div class="form-group col-sm-2 col-xs-12">
                                <label for="min_num">Min Number</label>
                                <input type="text" class="form-control" id="min_num" placeholder="" name="min_num">
                            </div>
                            <div class="form-group col-sm-2 col-xs-12">
                                <label for="max_num">Max Number</label>
                                <input type="text" class="form-control" id="max_num" placeholder="" name="max_num">
                            </div>
                            <div class="form-group col-sm-2 col-xs-12">
                                <label for="letter_grade">Letter Grade</label>
                                <input type="text" class="form-control" id="letter_grade" placeholder=""
                                       name="letter_grade">
                            </div>
                            <div class="form-group col-sm-2 col-xs-12">
                                <label for="grade_point">Grade Point</label>
                                <input type="text" class="form-control" id="grade_point" placeholder=""
                                       name="grade_point">
                            </div>
