        ...
        <div class="row" style="margin-top: 55px;">
            <section class="col-xs-12 connectedSortable">
                <div class="" style="color: black;" id="no_print1">
                    ...
                    <div class="box-body">
                        <p style="font-size: 20px;">Class Promotion</p>
                ...
                <div class="box box-info">
                    ...
                    <h3 class="box-title" style="color: black; text-align: center; padding-bottom: 10px;"><u>Class
                            Promotion</u></h3>
                    <div id="show_info">
...
<script type="text/javascript">
    ...
    $("#search_total_result").on("click", function () {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url(); ?>Get_ajax_value/get_total_result_for_promotion",
            data: post_data,
            success: function (data) {
                $('#show_info').html(data);
                $('#date_div').hide();
