        ...
        <div class="row" style="margin-top: 55px;">
            <section class="col-xs-12 connectedSortable">
                <div class="" style="color: black;">
                    <?php echo form_open_multipart('Insert/class_routine'); ?>
                    <div class="box-body">
                        <p style="font-size: 20px;">Upload CLass Routine</p>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center;">
                                        <a href="<?php echo base_url(); ?>assets/pdf/class_routine/<?php echo $single_value->pdf; ?>"
                                           target="_blank">View Class Routine</a>
                                    </td>
                                    <td style="text-align: center;"><?php echo date('d F, Y', strtotime($single_value->published_date)); ?></td>
                                    <td style="text-align: center;">
                                        <a style="margin: 5px;"
                                           href="<?php echo base_url(); ?>Show_edit_form/class_routine/<?php echo $single_value->record_id; ?>/main"
                                           class="btn btn-info">Edit
                                        </a>
                                        <a style="margin: 5px;"
                                           href="<?php echo base_url(); ?>Delete/class_routine/<?php echo $single_value->record_id; ?>/main"
