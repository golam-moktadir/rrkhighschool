        ...
        <div class="row" style="margin-top: 55px;">
            <section class="col-xs-12 connectedSortable">
                <div class="" style="color: black;">
                    <?php echo form_open_multipart('Insert/create_shift'); ?>
                    <div class="box-body">
                        <p style="font-size: 20px;">Create Shift</p>
                        <p style="font-size: 20px; color: #066;"><?php echo $msg; ?></p>
                        <div class="row">
                            <div class="col-sm-4 col-xs-8 form-group">
                                <label for="shift_name">Shift Name</label><small class="req">*</small>
                                <input type="text" class="form-control" id="shift_name" placeholder="Shift Name" required name="shift_name">
                            </div>
