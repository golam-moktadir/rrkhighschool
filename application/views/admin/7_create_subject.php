            ...
            <section class="col-sm-12 connectedSortable">
                <div class="" style="color: black;">
                    <div class="box-body">
                        ...
                        <?php echo form_open('Insert/create_subject'); ?>
                            <div class="col-sm-3">
                                    ...
                                    <select name="class_id" required id="class_id" class="form-control selectpicker"
                                            ...
                                            <?php if(isset($all_class)): ?>
                                                <?php foreach($all_class as $value): ?>
                                                    <option value="<?php echo $value->record_id; ?>"><?php echo "Class-".nfa($value->class_name); ?></option>
                                                <?php endforeach;?>
                                            <?php endif;?>
                                    </select>
                                </div>
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="subject_name" id="subject_name" required placeholder="Subject Name" class="form-control"> 
                                </div>
                            </div>
                            <div class="col-sm-2">
                                <div class="form-group">
                                    <label for="subject_code">Subject Code</label>
                                    <input type="text" name="subject_code" id="subject_code" placeholder="Subject Code" class="form-control"> 
                                </div>
                            </div>
                            <div class="col-sm-2">
                                <div class="form-group">
                                    <label for="subject_total_mark">Subject Total Mark</label><small class="req"> *</small>
                                    <input type="text" name="subject_total_mark" id="subject_total_mark" required placeholder="Subject Total Mark" class="form-control"> 
                                </div>
                            </div>
                            <div class="col-sm-2">
                                <div class="form-group">
                                    <label for="written_mark">Written Marks</label><small class="req"> *</small>
                                    <input type="text" name="written_mark" id="written_mark" required placeholder="Written Marks" class="form-control"> 
                                </div>
                            </div>
                            <div class="col-sm-2">
                                <div class="form-group">
                            ...
                            <div class="col-sm-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" disabled name="mcq_mark" id="mcq_mark" required placeholder="MCQ Marks" class="form-control"> 
                                </div>
                            </div>
                            <div class="col-sm-3">
                                <div class="form-group">
                            ...
                            <div class="col-sm-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" disabled name="practical_mark" id="practical_mark" required placeholder="Practical Marks" class="form-control"> 
                                </div>
                            </div>
                            <div class="col-sm-3">
                                <div class="form-group">
