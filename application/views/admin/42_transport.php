        ...
        <div class="row">
            <section class="col-xs-12 connectedSortable">
                <div class="box box-info" style="color: black;">
                    <?php echo form_open_multipart('Insert/transport'); ?>
                    <div class="box-body">
                        <p style="font-size: 20px;">Insert Transport Info.</p>
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-sm-4 col-xs-12">
                                    ...
                                    <input type="text" name="driver_mobile" id="driver_mobile" class="form-control">
                                </div>
                            </div>
                        </div>
                    </div>
