...
//                        echo $total_gpa.'<br>';
    ...
    public function get_all_admit_card() {
        $this->load->model('Common_model');
        $class_name = $this->input->post('class_name');
        $group_name = $this->input->post('group_name');
        $section_name = $this->input->post('section_name');
...
//        print_r($data['all_value']);
    ...
    public function get_teacher_sub_info() {
        ...
        if ($user_type == "admin" || $user_type == "teacher") {
            ...
            $table_name = '25_teacher_subject_management';
            $data['all_class'] = $this->Common_model->group_by_one_column_where('class_name', $checking_array, $table_name);
            $data['all_shift'] = $this->Common_model->group_by_one_column_where('shift_name', $checking_array, $table_name);
            $data['all_group'] = $this->Common_model->group_by_one_column_where('group_name', $checking_array, $table_name);
            $data['all_section'] = $this->Common_model->group_by_one_column_where('section_name', $checking_array, $table_name);
            $data['all_subject'] = $this->Common_model->group_by_one_column_where('subject_name', $checking_array, $table_name);
    ...
    public function get_teacher_class_subject_info() {
        ...
        if ($user_type == "admin" || $user_type == "teacher") {
            ...
            $table_name = '25_teacher_subject_management';
            $data['all_subject'] = $this->Common_model->check_value_get_data($table_name, $checking_array);
