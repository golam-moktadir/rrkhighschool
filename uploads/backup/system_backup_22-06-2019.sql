...
INSERT INTO `admin` (`id`, `role_id`, `name`, `username`, `password`, `temp_password`, `phone`, `status`, `ip`, `last_login`, `user_agent`, `created_at`) VALUES (1, 1, '', 'admin', '$2y$10$l.Xxdci0Nul6AF91xLZLKeSbTIx0/Csf/Q8BLqklwAVgw2Upl4wDS', '', '', 1, '::1', '2019-06-22 10:25:17', 'Chrome 74.0.3729.169Windows 10', '2019-06-22 10:25:17');
...
INSERT INTO `supplier` (`id`, `company_id`, `branch_id`, `name`, `code`, `tel`, `owner_name`, `email`, `address`, `running_year`, `status`, `created_at`) VALUES (1, 1, 2, 'Abul Khayar  Group', '2000', '23233343', 'sda', 'info@nabilparibahon.com', 'Dhaka', 1, 1, '2019-06-22 18:43:15');
